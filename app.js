...
(function initializeApp() {
    ...
    if (!window.location.href.includes('code=')) {
        ...
        // Example of using Amplify API within the existing logic
        async function saveUserPreferences(userId, mapView, favoriteLocations, selectedTheme) {
            try {
                ...
                const result = await API.graphql(graphqlOperation(createUserPreferences, { input }));
        ...
        // Example function to trigger saving preferences
        document.getElementById('savePreferences').addEventListener('click', async () => {
            ...
            await saveUserPreferences(userId, mapView, [], 'default');
        });
    }
})();
